    ...
    <section class="flex flex-col md:flex-row gap-4">
        ...
        <div class="bg-white p-8 rounded-lg shadow-md w-full">
            ...
            <div class="mt-4 bg-gray-100 p-2">
                ...
                @forelse ($job->applicants as $applicant)
                    <div class="py-2">
                        ...
                        <p class="text-gray-800 mt-2">
                            <a href="{{ asset('storage/' . $applicant->resume_path) }}" class="text-blue-500 text-sm hover:underline" download><i class="fas fa-download"></i> Download Resume</a>
                        </p>
                        {{-- Delete Applicant --}}
                ...
                @empty
                    <p class="text-gray-700 mb-5">No applicants for his job</p>
                @endforelse
            </div>
