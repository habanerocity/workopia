<x-layout>
    ...
    <div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl">
        ...
        @csrf
            ...
            <x-inputs.text-area id="requirements" name="requirements" label="Job Requirements" placeholder="Bachelor's degree in Computer Science" />
            ...
            <x-inputs.select id="job_type" name="job_type" label="Job Type" value="{{ old('job_type') }}" :options="['Full-Time' => 'Full-Time',
            ...
            <x-inputs.text-area id="description" name="description" label="Company Description" placeholder="Company Description" />
