<x-layout>
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div class="rounded-lg shadow-md bg-white p-3">
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex space-x-3 ml-4">
                        ...
                        >
                        <!-- Delete Form -->
                        <form method="POST" action="{{ route('jobs.destroy', $job->id) }}" onSubmit="return confirm('Are you sure you want to delete this joblisting?')">
                            @csrf
                            @method('DELETE')
                            <button
                                type="submit"
        ...
        <aside class="bg-white rounded-lg shadow-md p-3">
            ...
            @else
                <form method="POST" action="{{auth()->user()->bookmarkedJobs()->where('job_id', $job->id)->exists() ? route('bookmarks.destroy', $job) : route('bookmarks.store', $job) }}" class="mt-10">
                    @csrf
